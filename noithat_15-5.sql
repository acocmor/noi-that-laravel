...
INSERT INTO `chinh_sach` (`id`, `title`, `slug`, `content`, `hien_thi`, `created_at`, `updated_at`) VALUES
	(3, 'Chính sách bán hàng', 'chinh-sach-ban-hang', NULL, 1, '2021-02-17 14:03:03', '2021-02-17 22:53:42'),
	(4, 'Chính sách bảo hành', 'chinh-sach-bao-hanh', NULL, 1, '2021-02-17 14:03:11', '2021-02-17 14:03:11'),
	(5, 'Phương thức vận chuyển', 'phuong-thuc-van-chuyen', NULL, 1, '2021-02-17 14:03:17', '2021-02-17 14:03:17'),
	(6, 'Phương thức thanh toán', 'phuong-thuc-thanh-toan', NULL, 1, '2021-02-17 14:03:23', '2021-02-17 14:03:23'),
	(7, 'Chính sách đổi trả', 'chinh-sach-doi-tra', NULL, 1, '2021-02-17 14:03:29', '2021-02-17 14:03:29'),
	(8, 'Chính sách bảo mật', 'chinh-sach-bao-mat', '', 1, '2021-02-17 14:03:37', '2021-02-17 14:03:37');
...
INSERT INTO `loai_san_pham` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
	(1, 'Cổng', 'cong', '2021-02-10 02:27:27', '2021-02-10 14:12:34'),
	(2, 'Tường', 'tuong', '2021-02-10 02:27:31', '2021-02-10 02:27:31'),
	(3, 'Vách', 'vach', '2021-02-10 02:28:38', '2021-02-10 02:28:38'),
	(4, 'Cầu thang', 'cau-thang', '2021-02-10 20:26:04', '2021-02-10 20:26:04'),
...
INSERT INTO `san_pham` (`id`, `loai_san_pham_id`, `name`, `slug`, `hinh_anh`, `hien_thi`, `mo_ta`, `da_ban`, `gia`, `giam_gia`, `created_at`, `updated_at`) VALUES
	(1, 4, 'Cầu thang - CT1', 'cau-thang-ct1', 'jQeDB_xoAei_product7.jpg', 1, '<p>Đ&acirc;y l&agrave; cầu thang ct1</p>', 0, 0.00, 0.00, NULL, '2021-02-15 00:42:43'),
	(2, 4, 'Cầu thang - CT2', 'cau-thang-ct2', 'pVvnV_DVDrr_ct2.jpg', 1, '<p>Đ&acirc;y l&agrave; cầu thang ct2</p>', 0, 0.00, 0.00, NULL, '2022-05-14 20:01:57'),
	(5, 4, 'Cầu thang - CT3', 'cau-thang-ct3', '5qtNX_IlMKJ_ct3.jpg', 1, '<p>1. TH&Ocirc;NG TIN CHI TIẾT SẢN PHẨM:</p>\r\n\r\n<ul>\r\n	<li>M&atilde; sản phẩm: SFD60</li>\r\n	<li>Chất liệu: Khung gỗ tự nhi&ecirc;n. Ch&acirc;n inox mạ v&agrave;ng. Vỏ giả da nappa. C&oacute; thể k&ecirc; th&ecirc;m gối đầu chỗ tựa lưng.</li>\r\n	<li>M&agrave;u sắc: Xem chi tiết h&igrave;nh ảnh</li>\r\n	<li>Xuất xứ: Nhập khẩu&nbsp;</li>\r\n	<li>Vận chuyển: To&agrave;n quốc</li>\r\n	<li>Gi&aacute; th&agrave;nh k&egrave;m chất liệu da của&nbsp;sản phẩm:&nbsp;</li>\r\n</ul>\r\n\r\n<p><strong>Giả da:</strong></p>\r\n\r\n<p>Ghế 1 - 115*93*93:&nbsp;<strong>10.500.000</strong></p>\r\n\r\n<p>Ghế 2 - 162*93*93:&nbsp;<strong>20.100.000</strong></p>\r\n\r\n<p>Ghế 3 - 220*93*93:&nbsp;<strong>27.400.000</strong></p>\r\n\r\n<p>Ghế 3 + ghế chữ L - 325*105*93:&nbsp;<strong>42.300.000</strong></p>\r\n\r\n<p>Ghế 1 + 2 + 3:&nbsp;<strong>49.400.000</strong></p>', NULL, 0.00, 0.00, '2021-02-10 13:28:03', '2022-05-14 20:01:57'),
	(7, 4, 'Cầu thang - CT4', 'cau-thang-ct4', 'nJZLq_JsI6K_product4.jpg', 1, NULL, NULL, 0.00, 0.00, '2021-02-10 13:30:20', '2022-05-14 20:01:57'),
	(8, 1, 'Cổng nhà - CN1', 'cong-nha-cn1', 'WPh9I_yH8A6_product5.jpg', 1, 'đághjkljhgfdssa', NULL, 0.00, 0.00, '2021-02-10 13:31:34', '2022-05-14 20:01:58'),
	(11, 3, 'Vách gỗ xoan - VGX1', 'vach-go-xoan-vgx1', 'a2pSQ_z8tiN_product7.jpg', 1, NULL, NULL, 0.00, 0.00, '2021-02-10 13:31:51', '2022-05-14 20:01:59'),
	...
	(23, 1, 'Cổng Đồng - CD1', 'cong-dong-cd1', 'KlQYC_GXLF5_cong dong.jpg', 1, '<p>M&ocirc; tả sản phẩm...</p>', NULL, 0.00, 0.00, '2021-02-15 00:39:33', '2022-05-14 20:02:00'),
	(24, 1, 'Cổng Đồng - CD2', 'cong-dong-cd2', 'ypWZx_wPnB5_cong dong 2.jpg', 1, '<p>M&ocirc; tả sản phẩm...</p>', NULL, 0.00, 0.00, '2021-02-15 00:41:26', '2022-05-14 20:02:01'),
	(25, 1, 'Cổng Đồng - CD3', 'cong-dong-cd3', 'WSRhd_A4NkF_congdong3.png', 1, '<p>M&ocirc; tả sản phẩm...</p>', 6, 1000000.00, 1000000000.00, '2021-02-15 00:42:14', '2022-05-15 13:22:02');
...
INSERT INTO `website` (`id`, `name_website`, `ten_cong_ty`, `dia_chi`, `logo`, `hotline`, `email`, `banner`, `slide`, `social_facebook`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'https://inoxnhadep.com', 'Inox Nhà Đẹp', NULL, 'r4gul_BjAOz_logo.png', NULL, NULL, '', 'slide1.jpg', NULL, NULL, NULL, '2021-02-17 23:33:06');
