        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form role="form" action="{{ route('admin.sanpham.postThem') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" name="name" placeholder="Độ dài tên lớn hơn 3...">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" style="width: 30%" class="form-control" id="giamgia" name="giamgia"
                                        placeholder="Nhập mức giảm giá" value="0">
                                    <p class="help-block"><i> Giá hiển thị = (Giá gốc - Mức giảm giá)</i> </p>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="ckeditor" id="mota" name="mota"
                                        placeholder="Nhập mô tả sản phẩm...">Mô tả sản phẩm...</textarea>
