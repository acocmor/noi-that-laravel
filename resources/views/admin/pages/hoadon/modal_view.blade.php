<div class="modal fade" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <h4 style="margin-left: 30px;">Số điện thoại: <span id="sdt" style="color:red;"></span></h4>
            <h4 style="margin-left: 30px;">Email: <span id="email" style="color:red;"></span></h4>
            <h4 style="margin-left: 30px;">Địa chỉ: <span id="dia_chi" style="color:red;"></span></h4>
            </p>
            <p>
