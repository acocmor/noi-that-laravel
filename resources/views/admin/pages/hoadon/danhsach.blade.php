...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Danh sách hoá đơn đặt hàng</h1>
        </div>
    </div>
    @if (count($errors) > 0)
    ...
    @include('admin.pages.hoadon.modal_view')
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    data.chi_tiet_hdx.forEach((element, index) => {
                        if (element.sanpham != null) {
                            html = `
                                <tr>
                                    <td>${index+1}</td>
                                    <td>${element.sanpham.name}</td>
