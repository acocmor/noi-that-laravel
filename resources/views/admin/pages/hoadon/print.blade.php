...
<body>
   ...
   <div class="main">
        <table>
            ...
            <tr>
                <td>Khách hàng: </td>
                <th style="padding-left: 30px; text-align: left;">{{$hdx->ho_ten}}</th>
            </tr>
            <tr>
                <td>Số điện thoại: </td>
                <th style="padding-left: 30px; text-align: left;">{{$hdx->sdt}}</th>
            </tr>
            <tr>
                <td>Email: </td>
                <th style="padding-left: 30px; text-align: left;">{{$hdx->email}}</th>
            </tr>
            <tr>
                <td>Địa chỉ: </td>
                <th style="padding-left: 30px; text-align: left;">{{$hdx->dia_chi}}</th>
            </tr>
            <tr>
                <td>Ngày lập: </td>
        ...
        <tbody>
            @if(isset($cthdx))
                ...
                @foreach ($cthdx as $item)
                    <tr class="tr-nhap">
                        <td>{{$i++}}</td>
                        <td>{{$item->sanpham?$item->sanpham->name:''}}</td>
                        <td>{{$item->so_luong}}</td>
