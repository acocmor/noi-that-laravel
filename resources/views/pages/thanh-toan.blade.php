        ...
        <div class="row">
            <div class="col-6">
                <form action="{{ route('index.postPayment') }}" method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-header" style="color: white; background: #007bff;">Thông tin khách hàng</div>
                        @if (count($errors) > 0)
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="ho_ten" id="ho_ten" class="form-control"
                                        value="" placeholder="Điền họ và tên" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control"
                                        value="" placeholder="Điền địa chỉ email" />
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12">
            ...
            <div class="col-5">
                <div class="card">
                    <div class="card-header" style="color: white; background: #007bff;">
                        Chi tiết đặt hàng
                        <span>
                            <a class="float-right" style="color: #fff" href="{{ route('index.cart') }}">Quay lại trang
                                đặt
                                hàng</a>
                        </span>
                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-3 col-xs-3">
                                            <img class="img-responsive" src="{{ asset('upload/sanpham/' . $item['sanPhamInfo']->hinh_anh) }}"
                                                width="130px" height="80px" />
                                        </div>
                                        <div class="col-4 mt-5 ml-5 ">
                                            <div class="col-xs-12">{{ $item['sanPhamInfo']->name }}</div>
                                            <div class="col-xs-12"><small>Số lượng:
                                                    <span>{{ $item['so_luong'] }}</span></small></div>
                                        </div>
                                        <div class="col-3 text-right mt-5">
                                            <h6><span>{{ number_format($item['sanPhamInfo']->gia - $item['sanPhamInfo']->giam_gia) }}</span>
                                                VNĐ</h6>
                                        </div>
                                    </div>
                                </div>
